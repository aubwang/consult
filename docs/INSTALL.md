...
ACP permission handling predates the launch pins Consult relies on, refuse
agents that do not report a verifiable Copilot version, and pin
`--no-auto-update` on delegated launches.
