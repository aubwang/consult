...
function capabilitiesForScenario(currentScenario) {
...
function sessionControlsForScenario(currentScenario) {
...
function logAgentMethod(message) {
...
function writeUpdate(sessionId, text) {
  writeMessage({
    jsonrpc: "2.0",
...
function writeAutoApprovedEdit(sessionId, editPath) {
  writeMessage({
    jsonrpc: "2.0",
    method: "session/update",
    params: {
...
function writeClaudeStyleEdit(sessionId, editPath) {
  writeMessage({
    jsonrpc: "2.0",
    method: "session/update",
    params: {
...
function callClient(method, params, onResponse) {
...
function logClientObservation(method, message) {
  if (clientLogPath) {
